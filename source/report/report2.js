   ...
   //   console.log(dataChart);
          ...
          const renderItem = ({ item,index }) => (
              ...
              >
                  ...
                  <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center' }}>
                      ...
                      <Text style={{ marginLeft: SIZES.base, color: (selectedCategory && selectedCategory.name == item.name) ? COLORS.white : COLORS.primary, ...FONTS.h4 }}>{item.name}</Text>
                  </View>
  
                  {/* Expenses */}
                  <View style={{flex:1, justifyContent:'center'}}>
                  <View style={{ alignItems:'flex-end' }}>
                      <Text style={{ color: (selectedCategory && selectedCategory.name == item.name) ? COLORS.white : COLORS.primary, ...FONTS.h4 }}>{item.Count} - {parseInt(item.label)>=10?item.label:'0'+item.label}</Text>
                  </View>
                  <View style={{alignItems:'flex-end'}}>
      ...
      function renderList(){
        return( 
          ...
          <View style={[styles.viewOrder,{flex:0.48}]} ><Text style={styles.menuOrder}>Món ăn</Text></View> 
          <View style={[styles.viewOrder,{flex:0.18}]}><Text style={styles.menuOrder}>SL tô</Text></View> 
